...
export const NavigationMenuBar = () => {
  ...
  useEffect(() => {
    const initializeProfile = () => {
      ...
      if (role && role !== "") {
        setProfileData({
          name: name || (role === 'host' ? 'Host' : 'Cleaner'),
          email: email || (role === 'host' ? 'host@example.com' : 'cleaner@example.com'),
  ...
  return (
    <header className="sticky top-0 z-40 bg-white h-20 backdrop-blur-md border-b border-gray-200 supports-backdrop-blur:bg-white/60">
