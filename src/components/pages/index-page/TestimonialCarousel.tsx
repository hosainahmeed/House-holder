...
const TestimonialCarousel: React.FC = memo(() => {
    ...
    return (
        <>
            ...
            >
                <div
                    className="w-full container backdrop-blur-sm md:px-4 mx-auto my-4 flex items-center justify-center md:h-[calc(100vh-200px)] relative overflow-hidden"
                    role="region"
                    aria-label="Testimonials carousel"

                >
                    <div className="absolute hidden md:block border-l-0 border-12 border-white top-[50%] translate-y-[-50%] left-0 w-[50%] p-4 h-[600px]">
                        <div className="w-full h-full"></div>
                    </div>
                    <div className="relative overflow-hidden max-w-7xl h-fit z-10 flex items-center justify-center px-4 py-8">
                        <div className="w-full bg-white overflow-hidden p-6 rounded-2xl container mx-auto">
                                ...
                                >
                                    <div className="relative">
                                        ...
                                        <motion.div
                                            ...
                                            className="absolute hidden md:block -top-2 rounded bg-linear-to-r from-[#BF0A30] via-[#BF0A30] to-[#003F91] -left-4 h-[105%] w-full -z-10"
                                        />
                                    </div>
                                </motion.div>
                            </div>
