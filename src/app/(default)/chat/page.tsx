...
const Page = () => {
  ...
  return (
    <div className="container mx-auto flex h-[calc(100vh-5rem)] w-full bg-white md:p-4 gap-4 overflow-hidden">
      <div className={cn(
        "absolute inset-0 z-999 bg-[#70C8FF] h-screen w-[75%] transition-transform duration-300 ease-in-out md:relative md:translate-x-0 md:max-w-[350px] md:flex md:rounded-2xl flex-col p-3 overflow-hidden",
